module github.com/solarlune/tetraflow
...
require (
	...
	github.com/solarlune/tetra3d v0.14.0
)

require (
	github.com/ebitengine/purego v0.4.0-alpha.1.0.20230327173358-ebd8567e49db // indirect
